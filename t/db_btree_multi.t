...
my $class = 'QDBM_File::BTree::Multiple';
my $tempdir  = "t/db_btree_multiple_temp";
mkpath($tempdir);
my $tempfile = File::Spec->catfile( $tempdir, "db_btree_multiple_test" );
...
my $temp_default = File::Spec->catfile( $tempdir, "db_btree_multi_default_test" );
